...
# Introduction
In a session consistency model ([[Backend Engineering - Distributed systems - Consistency models|link]]), a service or user is guaranteed a consistent view of data within a single session. 
