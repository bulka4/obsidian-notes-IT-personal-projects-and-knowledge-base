...
# Introduction
Outbox pattern is a data consistency pattern ([[Backend Engineering - Distributed systems - Data Consistency Patterns (distributed transactions)|link]]) used in event-driven systems ([[Backend Engineering - Event-driven architecture|link]]) when we need to:
- update database
