...
- What is the operation log ([[Backend Engineering - Distributed microservices - State|link]]) (what operations were performed, in what order and what is the latest state).
...
Consensus algorithms are used to decide what is the official operation log ([[Backend Engineering - Distributed microservices - State|link]]) (what operations were performed, in what order and what is the latest state).
