...
# Introduction
Consistency models define how and when state ([[Backend Engineering - Distributed microservices - State|link]]) changes become visible across the system (services) after a write.
# Why it matters
