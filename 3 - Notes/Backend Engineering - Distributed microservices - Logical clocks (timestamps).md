...
# Introduction
Logical clocks are a method used to order events in distributed systems ([[Backend Engineering - Distributed microservices|link]]) without relying on physical time. 
...
- Lamport clocks ([[Backend Engineering - Distributed microservices - Lamport logical clock|link]])
- Vector clocks ([[Backend Engineering - Distributed microservices - Vector clocks|link]])