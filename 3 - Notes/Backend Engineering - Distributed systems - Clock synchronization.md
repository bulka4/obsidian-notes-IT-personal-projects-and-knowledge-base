...
# Introduction
Clock synchronization is about making sure that computers in a distributed system ([[Backend Engineering - Distributed systems|link]]) agree on what the time is.
