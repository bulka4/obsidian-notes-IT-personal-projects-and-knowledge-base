...
# Introduction
A stateful service is such a service which has a state ([[Backend Engineering - Distributed systems - State|link]]) - i.e. an information needed for that service to work properly, stored in some storage system.
