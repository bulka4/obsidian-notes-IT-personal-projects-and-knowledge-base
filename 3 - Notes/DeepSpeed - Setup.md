...
- All the servers active when initialization starts
	- I think this might not be correct since when we initialize a Torch Distributed process group, which DeepSpeed uses, it waits for all the processes to join
