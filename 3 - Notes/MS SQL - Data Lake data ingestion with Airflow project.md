...
This project uses functions from another project as well - [[MS SQL - Data Lake data ingestion project]].
...
``` 
# DAGs
Information about the DAG for data ingestion - [[MS SQL - Data Lake data ingestion with Airflow project - DAGs|link]].
# App prerequisites
