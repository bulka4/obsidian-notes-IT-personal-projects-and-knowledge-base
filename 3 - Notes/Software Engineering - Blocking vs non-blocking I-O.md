...
# Introduction
Blocking vs non-blocking I/O describes what happens when a program performs an I/O operation ([[Software Engineering - I-O operations|link]]).
# Blocking I/O
...
# Non-blocking I/O
The program starts an operation and continues doing other work while waiting for the operation to finish. It checks later whether the operation finished or receives a notification.

It can be implemented using async programming ([[Software Engineering - Async programming models|link]]).
