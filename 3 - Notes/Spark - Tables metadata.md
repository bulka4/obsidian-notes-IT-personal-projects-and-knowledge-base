...
To have a persistent metadata across sessions and also available for multiple sessions at once, we need to use an external metadata db like Hive Metastore.