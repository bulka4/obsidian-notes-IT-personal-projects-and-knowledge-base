...
# Introduction
For information about how to deploy Spark Thrift Server with an external Hive Metastore on Kubernetes refer to documents below about the 'Data and ML platform project'. 
